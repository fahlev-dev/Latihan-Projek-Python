...
root.title('DataaFlair-AddressBook')
root.resizable(0,0)
contactlist = [
...
# func to edit existing contact(first select the contact the click on view button then edit the contact and then click on edit button)
def EDIT():
